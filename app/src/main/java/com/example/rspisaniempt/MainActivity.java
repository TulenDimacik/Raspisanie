...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new MyLayout2Model("Четверг","Нежинская","Инструментальные средства разработки ПО","","Технология разработки ПО","","Иностранный язык","","Технология разработки и защиты БД","","",""));
